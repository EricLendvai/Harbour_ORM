...
class hb_orm_SQLConnect
    hidden:
        ...
        method GMSSAddTable(par_hTablePrimaryKeyInfo,par_cNamespaceName,par_cTableName,par_hStructure,par_lUnlogged)
    ...
    exported:
        ...
        data p_hTablePrimaryKeyInfo init {=>}                            //Updated when the method LoadWharfConfiguration() is called This will speed up handling primary keys. One entry per Namespace.table as an array [<ColumnName>,<ColumnType>]
        ...
        method SetAllSettings(par_cBackendType,par_cDriver,par_Server,par_nPort,par_cUser,par_cPassword,par_cDatabase,par_cSchema)
        method Connect()
        method Disconnect()
        method GetHandle()
